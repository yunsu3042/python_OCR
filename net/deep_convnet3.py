...
class DeepConvNet:
    def __init__(self, input_dim=(1,28,28), file_path=None,
                conv_params1={'filter_num':64, 'filter_size':3, 'pad':1, 'stride':1},
                conv_params2={'filter_num':64, 'filter_size':3, 'pad':1, 'stride':1},
                conv_params3={'filter_num':128, 'filter_size':3, 'pad':1, 'stride':1},
                conv_params4={'filter_num':128, 'filter_size':3, 'pad':2, 'stride':1},
                conv_params5={'filter_num':256, 'filter_size':3, 'pad':1, 'stride':1},
                conv_params6={'filter_num':256, 'filter_size':3, 'pad':1, 'stride':1},
                hidden_size=100, output_size=62):
